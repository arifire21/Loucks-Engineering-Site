  ...
  return (
    ...
    <Head>
      ...
      <main>
        ...
        <section className={styles.aboutItem}>
          <h2>History</h2>
            <p className={styles.abtPara}>Our company was founded in <strong>1966</strong>, and continues to remain a family business. We do what we can to support all who work here so that their tenure is long. This has built a conscientious team that takes great pride in their work.</p>
        </section>
        </div>
